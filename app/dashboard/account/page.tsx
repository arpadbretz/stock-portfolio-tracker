                    ...
                    <div className="md:col-span-1 space-y-6">
                        <div className="bg-card border border-border p-8 rounded-[40px] text-center">
                            ...
                            <div className="pt-6 border-t border-border/50 text-left">
                                <div className="text-[10px] text-muted-foreground font-black uppercase tracking-tighter mb-2">Member Reference</div>
                                <code className="text-[10px] bg-muted px-3 py-1.5 rounded-lg block font-mono text-center">{user.id}</code>
                            </div>
                        </div>
