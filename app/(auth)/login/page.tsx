                ...
                <div className="bg-card/40 backdrop-blur-3xl border border-border/50 p-10 rounded-[48px] shadow-2xl shadow-black/20">
                    ...
                    <div className="space-y-3 mb-8">
                        ...
                        <button
                            ...
                            disabled={oauthLoading !== null}
                            className="w-full py-4 bg-black text-white rounded-2xl font-bold text-sm hover:bg-gray-900 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                        >
                            {oauthLoading === 'apple' ? (
