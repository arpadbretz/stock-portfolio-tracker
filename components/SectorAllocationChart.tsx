                ...
                {data.map((item, index) => (
                    <div key={item.name} className="flex items-center justify-between p-3 rounded-2xl bg-muted/30 border border-transparent hover:border-border transition-all group/item">
                        <div className="flex items-center gap-4">
                            ...
                            />
                            <span className="text-foreground font-black text-sm uppercase tracking-tight group-hover/item:text-secondary transition-colors truncate max-w-[120px]">{item.name}</span>
                        </div>
